...
public class SimplePageServiceValidator implements PageServiceValidator{
    ...
    private static final String REGEXP_PATTERN_FOR_TEXT_FIELDS = "^.+$";
    private static final String REGEXP_PATTERN_FOR_INTEGER_FIELDS = "^[0-9]{1,2}$";
    @Override
    public boolean validateCreateAndUpdatePage(String title, String description, String slug, String menuLabel, String h1, Date publishedAt, Integer priority, String content, Integer ... pageId) {
    ...
    private boolean validateFieldsByPattern(String regexpPattern, String ... varchar){
        ...
        for(String currentVarchar : varchar){
            final Matcher matcher = pattern.matcher(currentVarchar);
            if(!matcher.find()){
                return false;
            }
        }
